(function($) {
	...
	$.fn.magnetize = function(options) { 
		...
		function createContainers(planes) {
			var CanvasArray = '<div class="close"></div><div class="dark-layer l2"></div><div class="dark-layer l1"></div><div class="img-caption"><p></p></div><div class="navig"><div class="act">Patrons</div><div>Faculty</div><div>Student</div></div>',
				corner;
			for (var k=0; k < length; k++) {
