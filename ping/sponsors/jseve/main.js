...
var App = {
	...
	sliderInit: function() {
		...
		if($('#carousel').length) {
			$.mbBgndGallery.buildGallery({
				...
				images:[
					"http://i60.tinypic.com/sys112.jpg",
					"http://i57.tinypic.com/2vnlyxt.jpg",
					"http://i58.tinypic.com/maicte.jpg",
					"http://i62.tinypic.com/316nhvk.jpg",
					"http://i61.tinypic.com/30xislf.jpg",
				]
	...
	create_map: function(mapContainer) {
		...
		var mapOptions = {
			center: new google.maps.LatLng(12.968750, 79.155913), //12.968750, 79.155913
			zoom: 15,
	...
	create_marker: function() {
		...
		myPin = new google.maps.LatLng(12.968750, 79.155913);
